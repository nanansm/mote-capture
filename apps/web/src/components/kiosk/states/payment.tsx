...
// Vite inlines `import.meta.env.DEV` at build time, so the dev panel
// disappears entirely from production bundles — not just hidden via a
// runtime check. (Equivalent to `process.env.NODE_ENV !== "production"` in
// the Next.js original.)
