// Ported from apps/cloud/lib/validations/booth.ts — unchanged, booths never
// had a `*Url` field so there's nothing to rename to `*Key` here.
import { z } from "zod";
...
export type BoothUpdateForm = z.infer<typeof boothUpdateSchema>;
